...
/**
 * Formatea los resultados de categorías para uso en prompts
 */
export function formatCategoryResults(categoryResults: any[]): string {
...
/**
 * Formatea el análisis OCEAN para uso en prompts
 */
export function formatOceanAnalysis(oceanData: any): string {
  return oceanData.dimensions.map((dim: any) => {
    return `
