-- PASO 1: Crear las nuevas tablas según especificación del sistema de Evaluación Cognitiva Integral
...
-- 5. Migrar datos existentes de preguntas_cognitivas a preguntas_cognitivas_banco
...
SELECT 
    ...
    END,
    texto_instruccion,
    COALESCE(texto_pregunta, enunciado_pregunta),
    recurso_visual_url,
    CASE 
