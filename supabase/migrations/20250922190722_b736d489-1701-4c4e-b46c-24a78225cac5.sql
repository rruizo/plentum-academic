-- Función para purgar datos de usuarios específicos
...
BEGIN
  ...
  RETURN FORMAT('PURGADO DE %s USUARIOS - Cache: %s, Intentos: %s, Sesiones: %s, Asignaciones: %s, Notificaciones: %s, Credenciales: %s, Respuestas: %s, Resultados: %s, HTP Submissions: %s, HTP Análisis: %s', 
    user_count, deleted_analysis_cache, deleted_attempts, deleted_sessions, deleted_assignments, deleted_notifications, deleted_credentials, deleted_responses, deleted_results, deleted_htp_submissions, deleted_htp_analysis);
END;
$function$;